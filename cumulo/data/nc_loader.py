...
keys = ['ev_250_aggr1km_refsb_1', 'ev_250_aggr1km_refsb_2', 'ev_1km_emissive_29', 'ev_1km_emissive_33',
        ...
        'cloud_water_path', 'cloud_optical_thickness', 'cloud_effective_radius', 'cloud_phase_optical_properties',
        'cloud_top_pressure', 'cloud_top_height', 'cloud_top_temperature', 'cloud_emissivity',
        'surface_temperature',

        'latitude', 'longitude',

        'cloud_mask', 'cloud_layer_type', 'cloud_layer_base', 'cloud_layer_top', 'precipitation_flag']
...
def read_nc_full(nc_file):
    ...
    for name in keys:
        data[name] = np.array(file.variables[name][:])
