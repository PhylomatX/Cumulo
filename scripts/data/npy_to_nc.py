...
swath_channels = ['ev_250_aggr1km_refsb_1', 'ev_250_aggr1km_refsb_2', 'ev_1km_emissive_29', 'ev_1km_emissive_33',
                  ...
                  'ev_1km_emissive_27', 'ev_1km_emissive_20', 'ev_1km_emissive_21', 'ev_1km_emissive_22',
                  'ev_1km_emissive_23', 'latitude', 'longitude', 'cloud_water_path', 'cloud_optical_thickness',
                  'cloud_effective_radius', 'cloud_phase_optical_properties', 'cloud_top_pressure', 'cloud_top_height',
                  'cloud_top_temperature', 'cloud_emissivity', 'surface_temperature', 'cloud_mask']
...
if __name__ == "__main__":
    ...
    copy, variables = copy_dataset_structure(os.path.join("netcdf", "cumulo.nc"),
                                             os.path.join(save_dir, month, status, copy_name))
